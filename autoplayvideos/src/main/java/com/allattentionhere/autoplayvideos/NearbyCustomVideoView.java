...
public class NearbyCustomVideoView extends TextureView implements TextureView.SurfaceTextureListener {
    ...
    public NearbyCustomVideoView(Context context) {
        this(context, null, 0);
    }

    public NearbyCustomVideoView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NearbyCustomVideoView(Context context, AttributeSet attrs, int defStyle) {
