...
public class NearbyCustomRecyclerView extends RecyclerView {
    ...
    public NearbyCustomRecyclerView(Context context) {
        super(context);
    }

    public NearbyCustomRecyclerView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public NearbyCustomRecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
...
//                        Log.d("pos", "recyclerview left: " + rect_parent.left + " | right: " + rect_parent.right + " | top: " + rect_parent.top + " | bottom: " + rect_parent.bottom);
                if (playOnlyFirstVideo) {
                    ...
                    for (int i = firstVisiblePosition; i <= lastVisiblePosition; i++) {
                        ...
                        try {
                            NearbyCustomViewHolder cvh = (NearbyCustomViewHolder) holder;
