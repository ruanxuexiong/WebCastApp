...
public class FollowCustomVideoView extends TextureView implements TextureView.SurfaceTextureListener {
    ...
    public FollowCustomVideoView(Context context) {
        this(context, null, 0);
    }

    public FollowCustomVideoView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FollowCustomVideoView(Context context, AttributeSet attrs, int defStyle) {
