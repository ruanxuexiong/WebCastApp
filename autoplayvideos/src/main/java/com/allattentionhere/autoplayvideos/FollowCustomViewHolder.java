...
public class FollowCustomViewHolder  extends RecyclerView.ViewHolder {


    private FollowCustomVideoImage aah_vi;
    ...
    public FollowCustomViewHolder(View x) {
        super(x);
        aah_vi = (FollowCustomVideoImage) x.findViewWithTag("follow_aah_vi");
    }
    ...
    public FollowCustomVideoImage getAah_vi() {
        return aah_vi;
    }
    ...
    public void setAah_vi(FollowCustomVideoImage aah_vi) {
        this.aah_vi = aah_vi;
    }
