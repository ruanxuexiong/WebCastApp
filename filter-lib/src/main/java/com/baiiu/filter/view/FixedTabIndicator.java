...
public class FixedTabIndicator extends LinearLayout {
    ...
    private int mTabVisibleCount = 3;// tab数量
    ...
    private int mLineColor = getResources().getColor(R.color.gray_dd);


    private int mTabTextSize = 14;// 指针文字的大小,sp
    private int mTabDefaultColor = getResources().getColor(R.color.gray_66);// 未选中默认颜色
    private int mTabSelectedColor = getResources().getColor(R.color.blue_1A);// 指针选中颜色
    ...
    private void init(Context context) {
        ...
        setBackgroundColor(getResources().getColor(R.color.blue_F7));
