...
public class PriceMoneyEditText extends EditText {


    private static final String TAG = "MoneyEditText";
    private boolean textChange;

    public PriceMoneyEditText(Context context) {
        this(context, null);
    }

    public PriceMoneyEditText(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PriceMoneyEditText(Context context, AttributeSet attrs, int defStyleAttr) {
