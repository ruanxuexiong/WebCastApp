package com.android.common.ui.pull;
...
import com.android.common.ui.pull.pullableview.Pullable;
...
public class PullToRefreshLayout extends RelativeLayout {
     ...
     *
     * @param refreshResult PullToRefreshLayout.SUCCEED代表成功，
    ...
    public void loadmoreFinish(int refreshResult) {
        ...
        switch (refreshResult) {
            ...
            case NULL: // 数据为空
                loadStateImageView.setVisibility(View.VISIBLE);
                loadStateTextView.setText(R.string.load_null);
    ...
    private class AutoRefreshAndLoadTask extends AsyncTask<Integer, Float, String> {
        ...
        protected String doInBackground(Integer... params) {
            while (pullDownY < 4 / 3 * refreshDist) {
                pullDownY += MOVE_SPEED;
                // Log.i("tag", refreshDist+" : "+pullDownY+" : "+params[0]);
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        if (!isLayout) {
            // 这里是第一次进来的时候做一些初始化
            refreshView = findViewById(R.id.head_view);
            pullableView = getChildAt(1);
            loadmoreView = findViewById(R.id.loadmore_view);
            isLayout = true;
            initView();
