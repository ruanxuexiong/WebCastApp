...
public abstract class BaseScrollViewFragment extends BaseRequestFragment implements PullToRefreshLayout.OnRefreshListener {
    ...
    //public abstract void popuWebCastData(String success);
