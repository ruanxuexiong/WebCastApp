...
import static com.android.nana.R.id.add_education_txt_quit;
...
public class AddEducationActivity extends BaseActivity implements View.OnClickListener {
    ...
    private EditText mTxtName, mTxtJob;
    ...
    protected void findViewById() {
        ...
        mIvImage = findViewById(R.id.add_education_iv_image);
        mIvImagePhotograph = findViewById(R.id.add_education_iv_image_bg);
        mTxtName = findViewById(R.id.add_education_edit_company);
        mTxtJob = findViewById(R.id.add_education_edit_job);

        mTxtEntry = findViewById(R.id.add_education_txt_entry);
        mTxtQuit = findViewById(add_education_txt_quit);

        mTxtDelete = findViewById(R.id.add_education_txt_delete);
    }
    ...
    protected void init() {
        ...
        if (mJsonObject != null) {
            mEducationExperienceId = JSONUtil.get(mJsonObject, "id", "");
            mTxtName.setText(JSONUtil.get(mJsonObject, "name", ""));
            mTxtJob.setText(JSONUtil.get(mJsonObject, "major", ""));
    ...
    private void camera() {
      PictureSelector.create(AddEducationActivity.this)
    ...
    private void save() {
        ...
        if (mStartTime < mEndTime) {
            CustomerDbHelper.setEducationExperience(userId, name, job, beginTime, endTime, mHeadImage, mEducationExperienceId, mIOAuthCallBack);
        } else {
    ...
    private void delete() {
        ...
        DialogHelper.customAlert(this, "提示", "确定删除吗?", new DialogHelper.OnAlertConfirmClick() {
            ...
            public void OnClick() {
                ...
                CustomerDbHelper.deleteEducationExperience(mEducationExperienceId, mIOAuthCallBack);
    ...
    private IOAuthCallBack mIOAuthCallBack = new IOAuthCallBack() {
        ...
        public void onStartRequest() {
            ...
            UIHelper.showOnLoadingDialog(AddEducationActivity.this, "正在处理，请等待...");
        }
        ...
        public void getSuccess(String successJson) {
            ...
            if (mResultDetailModel.mIsSuccess) {
                ...
                UIHelper.showToast(AddEducationActivity.this, mResultDetailModel.mMessage);
        ...
        @Override
        public void getFailue(String failueJson) {
            UIHelper.showToast(AddEducationActivity.this, "获取数据失败，请稍后重试");
            UIHelper.hideOnLoadingDialog();
        }
    };
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.add_education_txt_entry:

                if (isSHowKeyboard(AddEducationActivity.this, v)) {
                }
                if (mTimePicker != null) {
                    mTimePicker.show();
                }
                break;
            case R.id.add_education_txt_quit:
