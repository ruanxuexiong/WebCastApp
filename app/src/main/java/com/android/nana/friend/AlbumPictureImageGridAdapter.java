...
public class AlbumPictureImageGridAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private Context mContext;
    private AlbumPictureListener mListener;
    private ArrayList<MeAlbumEntity.Article> mDataList = new ArrayList<>();

    public AlbumPictureImageGridAdapter(Context mContext, ArrayList<MeAlbumEntity.Article> mDataList, AlbumPictureListener mListener) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        MeAlbumEntity.Article entity = mDataList.get(position);
        ...
        if (entity.getType().equals("1")){//图片
            ...
            if (entity.getUserArticlePictures().size()!=0){
                Glide.with(mContext)
                        .asBitmap()
    ...
    public interface AlbumPictureListener{
