...
import com.android.nana.find.adapter.FriendCommentsAdapter;
...
public class FriendAdapter extends BaseAdapter {
    ...
    private ArrayList<FriendEntity.Moments> mDataList;
    ...
    public FriendAdapter(Context mContext, ArrayList<FriendEntity.Moments> mDataList, FriendListener mListener) {
    ...
    public View getView(final int position, View view, ViewGroup viewGroup) {
        ...
        final FriendEntity.Moments item = mDataList.get(position);
        ...
        mAdapter = new FriendCommentsAdapter(context, item.getComments());
...
//            viewHolder.mTextTv.setText(item.getContent());
            ...
            viewHolder.mTextTv.setText(WeiBoContentTextUtil.getWeiBoContent(item.getContent(), context, viewHolder.mTextTv, new WeiBoContentTextUtil.OnClistener() {
                ...
                public void toUserData(String name) {
                    for (FriendEntity.UserListBean userID : item.getUser_list()) {
                ...
                public void toArticle(String name) {
                    for (FriendEntity.Article article : item.getTag_list()) {
        ...
        if (item.getType().equals("2")) {
            final ArrayList<FriendEntity.Pictures> list = item.getUserArticlePictures();
            if (list == null || list.size() < 1) {
                viewHolder.mListView.setVisibility(GONE);
            } else {
                viewHolder.mListView.setAdapter(new NestFullListViewAdapter<FriendEntity.Pictures>(R.layout.item_video, list) {
                    @Override
                    public void onBind(final int pos, FriendEntity.Pictures pictures, NestFullViewHolder holder) {
                        ...
                        mVideoPlayerController.mVoiceIv.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                if (mVideoPlayerController.mVoiceIv.getDrawable().getConstantState().equals(drawableCs)) {
                                    ...
                                    SharedPreferencesUtils.setParameter(context, Constants.FOLLOW_VOICE, "nearby");
                                } else {
                                    mVideoPlayer.setVolume(50);
                                    mVideoPlayerController.mVoiceIv.setImageResource(R.drawable.icon_voice_open);
                                    SharedPreferencesUtils.removeParameter(context, Constants.FOLLOW_VOICE);
                                }
                            }
                        });

                        if (SharedPreferencesUtils.getParameter(context, Constants.FOLLOW_VOICE, "").equals("nearby")) {
                            mVideoPlayerController.mVoiceIv.setImageResource(R.drawable.icon_voice_close);
                        } else {
                            mVideoPlayerController.mVoiceIv.setImageResource(R.drawable.icon_voice_open);
                        }
            ...
            if (list == null || list.size() < 1) {
                ...
                viewHolder.mListView.setAdapter(new NestFullListViewAdapter<FriendEntity.Pictures>(R.layout.item_img, list) {
                    @Override
                    public void onBind(int pos, FriendEntity.Pictures pictures, NestFullViewHolder holder) {
                            ...
                            if (Integer.valueOf(list.get(0).getHeight()) > Integer.valueOf(list.get(0).getWidth())) {
                                ...
                                mLongImg.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View v) {
                                        ...
                                        for (FriendEntity.Pictures image : list) {
    ...
    public interface FriendListener {
        void onMsgClick(FriendEntity.Message message);
        ...
        void onAvatarClick(FriendEntity.Mine mine);
