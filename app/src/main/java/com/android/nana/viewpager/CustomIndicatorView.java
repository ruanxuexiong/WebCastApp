...
public class CustomIndicatorView extends View implements TabLayout.OnTabSelectedListener, ViewPager.OnPageChangeListener {
    ...
    public CustomIndicatorView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void initViews(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.CustomIndicatorView, defStyleRes, 0);
        mShapeHorizontalSpace = array.getInteger(R.styleable.CustomIndicatorView_horizontalSpace, 0);
        mShapeColor = array.getColor(R.styleable.CustomIndicatorView_fullColor, context.getResources().getColor(R.color.white));
        array.recycle();
