...
public class MeInviteFragment extends Fragment implements View.OnClickListener, PullToRefreshLayout.OnRefreshListener, RanAdapter.OnItemClickListener {

    private Context mContext;
    private String mUid, mMsg, mUrl, mType = "total", rank = "3";
    ...
    public static MeInviteFragment newInstance(Context context, String mUid, String msg, String mUrl) {
        MeInviteFragment fragment = new MeInviteFragment();
    ...
    private void initView(View view) {
        ...
        mLayout = (PullToRefreshLayout) view.findViewById(R.id.invite_refresh_view);
        mListView = (PullableListView) view.findViewById(R.id.invite_content_view);
        mLoadRL = (RelativeLayout) view.findViewById(R.id.default_load_vg_load);
        mMultipleStatusView = (MultipleStatusView) view.findViewById(R.id.multiple_status_view);
