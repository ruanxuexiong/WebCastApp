...
public class MeProfitFragment extends Fragment implements View.OnClickListener, PullToRefreshLayout.OnRefreshListener, RanAdapter.OnItemClickListener {

    private Context mContext;
    private String mUid, mMsg, mUrl, mType = "total";
    ...
    public static MeProfitFragment newInstance(Context context, String mUid, String mMsg, String mUrl) {
        MeProfitFragment fragment = new MeProfitFragment();
        Bundle bundle = new Bundle();
        bundle.putString("mUid", mUid);
        bundle.putString("mMsg", mMsg);
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container,
        ...
        if (!EventBus.getDefault().isRegistered(MeProfitFragment.this)) {
            EventBus.getDefault().register(MeProfitFragment.this);
        }
        initView(view);
        return view;
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.ranking_tv:
                ...
                dialog.show(fm, "profit_bottom_dialog");
                break;
            case R.id.fab:
...
//    private void loadData(String order, final int page, final String mid, String rank) {
...
//    }
    ...
    public void onDestroy() {
        super.onDestroy();
        //取消注册事件
        EventBus.getDefault().unregister(MeProfitFragment.this);
    }
