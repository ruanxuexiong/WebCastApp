...
public class PositionDropDownAdapter implements MenuAdapter {

    private final Context mContext;
    private OnFilterDoneListener onFilterDoneListener;
    private String[] titles;

    public PositionDropDownAdapter(Context context, String[] titles, OnFilterDoneListener onFilterDoneListener) {
