...
public class NearbyAdapter extends BaseAdapter {
    ...
    public NearbyAdapter(Context mContext, ArrayList<Moment.Moments> mDataList, FlowListener mListener, boolean isHide) {
    ...
    public View getView(final int position, View view, final ViewGroup viewGroup) {
        ...
        if (null != item.getComments() && item.getComments().size() > 0) {
            ...
            viewHolder.mHideTv.setVisibility(View.GONE);
        }
