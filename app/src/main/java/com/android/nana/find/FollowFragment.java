...
import com.android.nana.friend.FriendAdapter;
...
public class FollowFragment extends BaseFragment implements FriendAdapter.FriendListener {
    ...
    private ArrayList<FriendEntity.Moments> mDataList = new ArrayList<>();
    ...
    public void onResume() {
        super.onResume();
      //  getActivity().findViewById(R.id.main_frame).setVisibility(View.VISIBLE);
    ...
    private void loadLngLatData(boolean isRefresh, double lng, double lat) {
        ...
        FriendDbHelper.moments(mUserId, mPage, lng, lat, new IOAuthCallBack() {
            @Override
    ...
    public void initView() {
        ...
        mAdapter = new FriendAdapter(getActivity(), mDataList, this);
    ...
    public ArrayList<FriendEntity.Moments> parseMomentsData(String result) {
    ...
    public void onZanClick(View view,FriendAdapter.ViewHolder viewHolder) {
        FriendEntity.Moments item = mDataList.get((Integer) view.getTag());
    ...
    private void article(String mUserId, final FriendEntity.Moments item, final FriendAdapter.ViewHolder viewHolder) {
    ...
    public void onReportClick(View view) {
        FriendEntity.Moments mItem = mDataList.get((Integer) view.getTag());
        bottomMenu(mItem);
    }
    ...
    private void cancelGood(final FriendEntity.Moments item, final FriendAdapter.ViewHolder viewHolder) {//取消点赞
