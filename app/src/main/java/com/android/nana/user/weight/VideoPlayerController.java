package com.android.nana.user.weight;
...
public class VideoPlayerController extends NiceVideoPlayerController implements View.OnClickListener, SeekBar.OnSeekBarChangeListener, ChangeClarityDialog.OnClarityChangedListener {
    ...
    private void init() {
        LayoutInflater.from(mContext).inflate(R.layout.video_palye_controller, this, true);
    ...
    protected void onPlayStateChanged(int playState) {
        switch (playState) {
           ...
           /* case NiceVideoPlayer.STATE_PREPARED:
                ...
                break;*/
            case NiceVideoPlayer.STATE_PLAYING://正在播放
