...
public class WeiBoContentTextUtil {
    ...
    public static SpannableStringBuilder getWeiBoContent(final String source, final Context context, final TextView textView, final OnClistener onClistener) {
        ...
        while (matcher.find()) {
            ...
            if (at != null) {
                ...
                ForegroundColorSpan foregroundColorSpan = new ForegroundColorSpan(Color.parseColor("#586C94"));
                    ...
                    case MotionEvent.ACTION_UP:
                        ...
                        if (Math.abs(upX - downX) < slop && Math.abs(upY - downY) < slop) {
                            ...
                            if (downSection != null) {
                                ...
                                if (onClistener != null) {
                                    if (name.contains("@")) {
                                        String copy = name.replace("@", "");
                                        onClistener.toUserData(copy);
                                    } else if (name.contains("#")) {
                                        String copy = name.replace("#", "");
                                        onClistener.toArticle(copy);
                                    }
    ...
    public interface OnClistener {
        void toUserData(String string);

        void toArticle(String string);
    }
}
