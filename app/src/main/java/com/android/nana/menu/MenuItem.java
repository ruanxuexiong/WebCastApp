...
public class MenuItem {
    ...
    public WantedItemOnClickListener getWantedItemOnClickListener() {
        return wantedItemOnClickListener;
    }

    public void setWantedItemOnClickListener(WantedItemOnClickListener wantedItemOnClickListener) {
        this.wantedItemOnClickListener = wantedItemOnClickListener;
    }

    private WantedItemOnClickListener wantedItemOnClickListener;
