...
public class BottomMenuFragment extends DialogFragment {
    ...
    public BottomMenuFragment(boolean isSize) {
        this.isSize = isSize;
    }

    public BottomMenuFragment(String string, boolean isSize) {
        this.string = string;
        this.isSize = isSize;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        MenuItemAdapter menuItemAdapter = new MenuItemAdapter(getActivity().getBaseContext(), this.menuItems, isSize, string);
