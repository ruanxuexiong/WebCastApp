...
public class ImageBrowserActivity extends FragmentActivity {
    ...
    public static final String EXTRA_LONG_IMG_URLS = "image_long";

    private ImagePagerAdapter mAdapter;
    private ImageBrowserViewPager mPager;
    private int pagerPosition;
    private TextView indicator, mSave;
    private String isLongImg = "222";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (null != getIntent().getStringExtra(EXTRA_LONG_IMG_URLS)) {
            isLongImg = getIntent().getStringExtra(EXTRA_LONG_IMG_URLS);
        }
    ...
    private class ImagePagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            return ImageDetailFragment.newInstance(url, isLongImg);
        }
        ...
        imageLoader.loadImage(url, new ImageLoadingListener() {
            ...
            public void onLoadingComplete(String s, View view, Bitmap bitmap) {
                try {
                    ...
                    File myDir = new File(Environment.getExternalStorageDirectory(), "shunsea");
                    if (!myDir.exists()) {
                        myDir.mkdirs();
                    }
