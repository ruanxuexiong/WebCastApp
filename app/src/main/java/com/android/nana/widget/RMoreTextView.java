...
public class RMoreTextView extends TextView {
    ...
    public RMoreTextView(Context context) {
        super(context);
        setup();
    }

    public RMoreTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
        setup();
    }

    public RMoreTextView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        TypedArray a = context.obtainStyledAttributes(attributeSet, R.styleable.RMoreTextView);
        mMoreText = a.getString(R.styleable.RMoreTextView_rmtMoreText);
        mLessText = a.getString(R.styleable.RMoreTextView_rmtLessText);
        mMoreColor = a.getInteger(R.styleable.RMoreTextView_rmtMoreColor, Color.BLUE);
        mLessColor = a.getInteger(R.styleable.RMoreTextView_rmtLessColor, Color.BLUE);
        a.recycle();
