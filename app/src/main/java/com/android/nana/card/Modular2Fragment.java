...
public class Modular2Fragment extends BaseFragment {
    ...
    public static Modular2Fragment newInstance(String mHasCard, String mAddCard) {
        Modular2Fragment fragment = new Modular2Fragment();
    ...
    public static Modular2Fragment newInstance(String mHasCard, String mAddCard, String mCardId, String name, String post, String company, String phone, String mobile, String fax, String mail, String address, String code, String logo) {
        Modular2Fragment fragment = new Modular2Fragment();
        Bundle bundle = new Bundle();
        bundle.putString("mHasCard", mHasCard);
        bundle.putString("mAddCard", mAddCard);
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (!EventBus.getDefault().isRegistered(Modular2Fragment.this)) {
            EventBus.getDefault().register(Modular2Fragment.this);
        }
    }
    ...
    protected void initData() {
        ...
        if (null != args) {
            ...
            if (null != args.getString("name")) {
                ...
                mPhoneTv.setText("M：" + args.getString("phone"));
                mMobileTv.setText("T：" + args.getString("mobile"));
                mAddressTv.setText(args.getString("address"));
                mMailTv.setText("E：" + args.getString("mail"));
                mFaxTv.setText("F：" + args.getString("fax"));
                mCodeTv.setText("P：" + args.getString("code"));

                if ("".equals(args.getString("logo"))) {
                    isLogoNull = true;
                    mLogoIv.setImageDrawable(getResources().getDrawable(R.drawable.icon_mode2_logo));
                } else {
    ...
    public int onSetLayoutId() {
        return R.layout.fragment_modular2;
    }

    @Override
    public void initView() {
        mAddLogoIv = mContentView.findViewById(R.id.iv_add_logo);
    ...
    private void choiceLogo() {//头像
        ...
        PictureSelector.create(Modular2Fragment.this)
    ...
    private void bottomMenu() {
        ...
        menuItem2.setMenuItemOnClickListener(new MenuItemOnClickListener(bottomMenuFragment, menuItem2) {
            ...
            public void onClickMenuItem(View v, MenuItem menuItem) {
                ...
                mLogoImage = null;
                isLogoNull = true;
                mAddLogoIv.setImageDrawable(getResources().getDrawable(R.drawable.icon_mode2_logo));
                mLogoIv.setImageDrawable(getResources().getDrawable(R.drawable.icon_mode2_logo));
            }
        });
    ...
    public void onDestroy() {
        super.onDestroy();
        EventBus.getDefault().unregister(Modular2Fragment.this);
    }


    @Subscribe(threadMode = ThreadMode.POSTING)
    public void onEdit2Card(Modular2EditFragmentEvent event) {
        ...
        if ("".equals(event.mail)) {
            ...
            mMailTv.setText("E：" + event.mail);
        }

        if ("".equals(event.fax)) {
            mFaxTv.setVisibility(View.GONE);
        } else {
            mFaxTv.setText("F：" + event.fax);
        }
    ...
    @Subscribe(threadMode = ThreadMode.POSTING)
    public void onUpModular2data(Modular2FragmentEvent event) {
        showProgressDialog("", "加载中...");
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 1:
                    ...
                    CardDbHelper.addCard("1", bundle.getString("mid"), "", bundle.getString("name"), bundle.getString("post"), bundle.getString("company"), bundle.getString("phone"), file, mLogoImage, bundle.getString("mobile"), bundle.getString("fax"), bundle.getString("mail"), bundle.getString("code"), "2", bundle.getString("address"), new IOAuthCallBack() {
                        @Override
                ...
                case 2:
                    ...
                    CardDbHelper.addCard("1", mBundle.getString("mid"), mCardId, mBundle.getString("name"), mBundle.getString("post"), mBundle.getString("company"), mBundle.getString("phone"), mFile, mLogoImage, mBundle.getString("mobile"), mBundle.getString("fax"), mBundle.getString("mail"), mBundle.getString("code"), "2", mBundle.getString("address"), new IOAuthCallBack() {
                        @Override
                        public void onStartRequest() {
