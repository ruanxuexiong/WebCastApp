...
public class Modular1Fragment extends BaseFragment {

    private LinearLayout mImageContent;
    private LinearLayout mImagell;
    private ImageView mLogoAddIv;
    private String mHhasCard;//是否有名片
    private String mAddCard;//是否是添加名片
    ...
    private TextView mGoneAddressTv;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (!EventBus.getDefault().isRegistered(Modular1Fragment.this)) {
            EventBus.getDefault().register(Modular1Fragment.this);
        }
    }

    public static Modular1Fragment newInstance(String mHasCard, String mAddCard) {
        Modular1Fragment fragment = new Modular1Fragment();
    ...
    public static Modular1Fragment newInstance(String mHasCard, String mAddCard, String mCardId, String name, String post, String company, String phone, String mobile, String fax, String mail, String address, String code, String logo) {
        Modular1Fragment fragment = new Modular1Fragment();
        Bundle bundle = new Bundle();
        bundle.putString("mHasCard", mHasCard);
        bundle.putString("mAddCard", mAddCard);
    ...
    protected void initData() {
        ...
        if (null != args) {
            ...
            if (null != args.getString("name")) {
                ...
                mPhoneTv.setText(args.getString("phone"));
                mMobileTv.setText("电话：" + args.getString("mobile"));
                mAddressTv.setText(args.getString("address"));
                ...
                if ("".equals(args.getString("logo"))) {
                    isLogoNull = true;
                    mLogoIv.setImageDrawable(getResources().getDrawable(R.drawable.icon_mode1_logo));
                } else {
            ...
            } else if (null != args.getString("mAddCard")) {//-1代表没有名片
    ...
    public int onSetLayoutId() {
        return R.layout.fragment_modular1;
    }

    @Override
    public void initView() {
        mImagell = mContentView.findViewById(R.id.ll_img_content);
        mImageContent = mContentView.findViewById(R.id.ll_img_null);
        mLogoAddIv = mContentView.findViewById(R.id.iv_logo_add);

        mGoneAddressTv = mContentView.findViewById(R.id.tv_gone_address);
    ...
    public void bindEvent() {
        mLogoAddIv.setOnClickListener(this);
    ...
    private void choiceLogo() {//头像
        ...
        PictureSelector.create(Modular1Fragment.this)
            ...
            switch (requestCode) {
                case PictureConfig.CHOOSE_REQUEST:
                    ...
                    for (LocalMedia media : selectList) {
                        ...
                        mLogoAddIv.setImageURI(Uri.fromFile(new File(media.getCompressPath())));
                    }
                    break;
            }
        } else {
    ...
    private void bottomMenu() {
        ...
        menuItem2.setMenuItemOnClickListener(new MenuItemOnClickListener(bottomMenuFragment, menuItem2) {
            ...
            public void onClickMenuItem(View v, MenuItem menuItem) {
                ...
                mLogoImage = null;
                isLogoNull = true;
                mLogoAddIv.setImageDrawable(getResources().getDrawable(R.drawable.icon_mode1_logo));
                mLogoIv.setImageDrawable(getResources().getDrawable(R.drawable.icon_mode1_logo));
            }
        });
    ...
    public void onDestroy() {
        super.onDestroy();
        EventBus.getDefault().unregister(Modular1Fragment.this);
    }

    @Subscribe(threadMode = ThreadMode.POSTING)
    public void onEditCard(Modular1EditFragmentEvent event) {
        ...
        mPhoneTv.setText(event.phone);

        if (event.mobile.equals("")) {
        ...
        if ("".equals(event.address)) {
            mGoneAddressTv.setVisibility(View.GONE);
        } else {
            mGoneAddressTv.setVisibility(View.VISIBLE);
            mAddressTv.setText(event.address);
        }
    ...
    @Subscribe(threadMode = ThreadMode.POSTING)
    public void onUpdata(Modular1FragmentEvent event) {
        showProgressDialog("", "加载中...");
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 1:
                    ...
                    CardDbHelper.addCard("1", bundle.getString("mid"), "", bundle.getString("name"), bundle.getString("post"), bundle.getString("company"), bundle.getString("phone"), file, mLogoImage, bundle.getString("mobile"), bundle.getString("fax"), bundle.getString("mail"), bundle.getString("code"), "1", bundle.getString("address"), new IOAuthCallBack() {
                        @Override
                ...
                case 2:
                    ...
                    String mEditPath = Utils.saveImage(getActivity(), mImageContent);
                    File mFile = new File(mEditPath);
                    Bundle mBundle = msg.getData();

                    CardDbHelper.addCard("1", mBundle.getString("mid"), mCardId, mBundle.getString("name"), mBundle.getString("post"), mBundle.getString("company"), mBundle.getString("phone"), mFile, mLogoImage, mBundle.getString("mobile"), mBundle.getString("fax"), mBundle.getString("mail"), mBundle.getString("code"), "1", mBundle.getString("address"), new IOAuthCallBack() {
                        @Override
                        public void onStartRequest() {
